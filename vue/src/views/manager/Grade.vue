  ...
  <div>
    <div class="card" style="margin-bottom: 10px">
      ...
      <el-input style="width: 260px; margin-right: 10px" v-model="data.studentName" placeholder="请输入学生名称查询"
                :prefix-icon="Search"/>
      <el-button type="primary" plain="true" style="margin-left: 10px" @click="load">查询</el-button>
      <el-button type="info" plain="true" @click="reset">重置</el-button>
    </div>
        ...
        <el-table :data="data.tableData" style="width: 100%">
          ...
          <el-table-column label="操作" width="180">
            <template #default="scope">
              <el-button type="primary" size="small" plain="true" @click="handleEdit(scope.row)"
                         v-if="data.user.role === 'ADMIN'">编辑
              </el-button>
              <el-button type="danger" size="small" plain="true" @click="del(scope.row.id)"
                         v-if="data.user.role === 'ADMIN'">删除
              </el-button>
              <el-button type="primary" size="small" plain="true" @click="handleEdit(scope.row)"
                         v-if="data.user.role === 'STUDENT'">反馈
              </el-button>
            </template>
          </el-table-column>
        </el-table>
