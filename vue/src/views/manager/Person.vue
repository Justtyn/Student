  ...
  <div>
    <div class="card" style="padding: 40px">
      <el-form :model="data.form" ref="formRef" label-width="100px" label-position="right"
               style="padding-right: 40px ;width: 30%">
        <el-form-item label="学生头像">
          <el-upload class="avatar-uploader" action="http://localhost:9090/api/files/upload" :show-file-list="false"
...
const update = () => {
  request.put('/api/student/update', data.form).then(res => {
    if (res.code === '200') {
